          ...
          <>
            ...
            <div style={{
              ...
              <div style={{
                ...
                <WarningIcon />
                <h3 style={{
                  fontSize: "15px", fontWeight: 800, color: "#FF4444",
                  letterSpacing: "0.5px",
                ...
                <div style={{ paddingLeft: "8px", marginBottom: "16px" }}>
                  {[
                    ...
                    <div key={i} style={{
                      ...
                      <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#FF4444" strokeWidth="2" style={{ marginTop: "3px", flexShrink: 0 }}>
              ...
              <div style={{
                ...
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#FF4444" strokeWidth="2" style={{ flexShrink: 0, marginTop: "1px" }}>
                  <rect x="3" y="11" width="18" height="11" rx="2" ry="2"/>
                  <path d="M7 11V7a5 5 0 0 1 10 0v4"/>
                </svg>
                <p style={{ fontSize: "12px", color: "rgba(255,255,255,0.6)", lineHeight: 1.6, margin: 0 }}>
                  <strong style={{ color: "#FF4444" }}>Important:</strong> By proceeding with this refund request, you acknowledge that your account activity, access logs, IP addresses, and device information have been recorded and may be used as evidence in the event of a dispute or chargeback.
                </p>
              </div>
